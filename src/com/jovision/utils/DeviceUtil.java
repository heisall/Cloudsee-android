...
public class DeviceUtil {
	...
	public static Device addDevice2(Device device, String userName,
		 ...
		 * "mt":2015,"dguid":"S230829711","mid":12,"sid":"sidtest","dcs":2，,"dbt":0}
		 */
		...
		try {
			...
			jObj.put(JVDeviceConst.JK_DEVICE_CHANNEL_SUM, device
					.getChannelList().size());
			jObj.put(JVDeviceConst.JK_DEVICE_BIND_TYPE, device.getBindtype());
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	...
	public static int modifyChannalNum(String devYstNum,
        ...
        {
            JK_MESSAGE_ID           : <int> , 
            JK_MESSAGE_TYPE         : <int> ,    (FIX_DEVICE_CHANNEL 2061)
            JK_PROTO_VERSION        : <string> , (1.0)
            JK_LOGIC_PROCESS_TYPE   : <int> ,    (DEV_INFO_PRO 1)
            JK_SESSION_ID           : <string> ,
            JK_DEVICE_GUID          : <string> ,
            JK_DEVICE_CHANNEL_SUM   : <int>      (通道数)
        }
		 * */
		...
		{
				JK_MESSAGE_ID 		: <int> ,
				JK_MESSAGE_TYPE 	: <int> ,  (FIX_DEVICE_CHANNEL_RESPONSE 2062)
				JK_RESULT		: <int> 
		}
		 * */
		String requesRes = JVACCOUNT
